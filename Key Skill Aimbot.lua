...
local Config = {
    ...
    Secret          = "196", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/ak444ak195-commits/Script/refs/heads/main/Chick%F0%9F%90%94%20Skill%20Aimbot.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "Chick🐔 Skill Aimbot", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Chick🐔 Skill Aimbot", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "Chick🐔", -- The main title shown at the top of the GUI
    HubDescription  = "Chick🐔 Skill Aimbot" -- The text shown below the title
}
